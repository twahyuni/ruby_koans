...
class AboutBlocks < Neo::Koan
  ...
  # &standaloneblock is passing the block to the function.
  ...
  # NOTE:  This is sort of a reverse of what is noted above.
  # Whatever's passed into method_with_explicit_block MUST be a block,
  # and the code within the method presents a value upon which the &block
  # will act
