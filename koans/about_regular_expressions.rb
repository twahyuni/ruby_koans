...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why? http://ruby-doc.com/docs/ProgrammingRuby/html/tut_stdtypes.html
  ...
  # \w+ is "[a-zA-Z0-9]" so "Name:" is ignored
  ...
  # http://stackoverflow.com/questions/10691366/difference-between-abc-and-abc
  # http://stackoverflow.com/questions/4724588/using-alternation-or-character-class-for-single-character-matching
  # mlsimpson's Answer: A character class matches a range of characters, while an alternation matches specific instances within.
  ...
  # http://stackoverflow.com/questions/4626425/ruby-regex-question-wrt-the-sub-method-on-string

  # So "one two-three".sub(/(t\w*)/) { $1[0, 1] } searches for the pattern t\w*.
  # This finds the substring "two". Since the whole thing is in a capturing group, this substring is stored in $1.
  # Now the block is called and returns "two"[0,1], which is "t". So "two" is replaced by "t" and you get "one t-three".
end
