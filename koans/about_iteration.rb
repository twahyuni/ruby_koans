...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # reduce in Javascript. Apply the block cumulatively using the first block argument as the accumulator and the second arg as the next item from the list.
  end
  ...
  # within do..end it opens the file and close it when it ends.
  #
  #   file = File.open(filename)
  #   # code to read 'file'
  #
  # When you get to the "AboutSandwichCode" koan, recheck your answer.
  # do..end handles the "meat" part of a sandwich.
